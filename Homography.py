...
#
def EstimateHomography(estimation_thresh=0.6, img1=None, img2=None, use_builtin_ransac = True):
    ...
    if img1 is not None and img2 is not None:
        ...
        if not use_builtin_ransac:
            ...
            finalH, status = cv2.findHomography(pts_src, pts_dst, cv2.RANSAC, 5.0)
...
def main():
    ...
    if img1 is not None and img2 is not None:
        ...
        warpped = cv2.warpPerspective(img1, finalH, (img2.shape[1], img2.shape[0]))
        cv2.imwrite('wrapped.png', warpped)
